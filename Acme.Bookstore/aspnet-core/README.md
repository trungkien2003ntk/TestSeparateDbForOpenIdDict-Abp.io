...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0f8bf7fa-4025-47b1-a0d0-d987f50f33e8
```

> `0f8bf7fa-4025-47b1-a0d0-d987f50f33e8` is the password of the certificate, you can change it to any password you want.
